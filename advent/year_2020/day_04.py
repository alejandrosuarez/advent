...
While these documents are extremely similar, North Pole Credentials aren't issued by
...
def _validate_pt1(passport):
    ...
    return set(passport.keys()) & required == required
...
def _validate_pt2(passport):
    ...
    if hgt:
        ...
        if unit == "in" and 59 <= num <= 76:
            hgt_val = True
        elif unit == "cm" and 150 <= num <= 193:
            hgt_val = True
