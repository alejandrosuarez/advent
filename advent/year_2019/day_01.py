...
Your puzzle answer was 3271095.
...
Your puzzle answer was 4903759.
...
TEST = "100756"
ANSWERS = [33583, 3271095, 50346, 4903759]


def main():
    pt1 = lambda l: sum(n // 3 - 2 for n in l)
    pt2 = lambda l: sum(map(_calc_fuel, l))
